	...
	if moduleFolder:FindFirstChild(Item) then
		...
		if viewmodelFolder:FindFirstChild(Item) then
			...
			if framework.viewmodel and framework.module and character then
				...
				if character:WaitForChild("UpperTorso"):FindFirstChild("FireSound") then
					character:WaitForChild("UpperTorso"):FindFirstChild("FireSound"):Destroy()
				end
	...
	if input.UserInputType == Enum.UserInputType.MouseButton1 then
		if character and framework.viewmodel and framework.module then
			if framework.module.fireMode == "Semi" then
				fireAnim:Play()
				character.UpperTorso.FireSound:Play()
			end
